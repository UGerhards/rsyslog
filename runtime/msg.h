...
struct msg {
    ...
    #define MSG_WAS_PARSED 0x400
    /* message has been parsed at least once */
 ...
 */
static inline void __attribute__((unused)) MsgSetRawMsgSize(smsg_t *const __restrict__ pMsg, const size_t newLen) {
